...
./extractROIfiles.py --platform=17 --dayofyear=240,241,242,243 --band=8 --config=extract.yaml --data-dir=/mnt/g/GOESProj/data/sharedData/scratch/april_data
./extractROIfiles.py --platform=16 --dayofyear=240,241,242,243 --band=8 --config=extract.yaml --data-dir=/mnt/g/GOESProj/data/sharedData/scratch/april_data
    """
